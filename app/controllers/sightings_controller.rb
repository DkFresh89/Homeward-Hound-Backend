class SightingsController < ApplicationController
    ...
    def create_sighting
        ...
        new_sighting = {latitude: sighting_params['latitude'], longitude: sighting_params['longitude'], description: sighting_params['description'], user_id: sighting_params['user_id'], missing_flyer_id: sighting_params['missing_flyer_id']}
