...
User.new(name: 'Pesh', address: 'Cuesta de Anna Borrell 15
    Alicante, 21914', phone_number: '+1-546-829-2634', good_sam: false)
User.new(name: 'Nich', address: '7867 Adam Harbor Apt. 529
    Lanestad, WI 86385', phone_number: '+39 947 87 64 5939', good_sam: false)
User.new(name: 'Max', address: 'Cuesta de Rafael Carretero 71 Puerta 0 
    Granada, 26339', phone_number: '437-877-5994', good_sam: true)


    Dog.new(name: 'Romulus', breed: 'Rotty', size: 'Big', age: 8, temperament: 'Good Boy', image: [
    ...
    Dog.new(name: 'Dog de Nich', breed: 'Crazy', size: 'Medium', age: 2, temperament: 'Cray', image: [
    ...
    Dog.new(name: 'TBD', breed: 'Vizsla', size: 'Big', age: 1, temperament: 'TBD', image: [
